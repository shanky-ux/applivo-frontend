...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" ref={ref} className="py-24" style={{ background: "#0D1117" }}>
            ...
            {STEPS.map((step, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -6, boxShadow: "0 12px 40px rgba(16,185,129,0.12)" }}
                ...
                >
                  ...
                  <div
                    ...
                    style={{ background: step.iconBg, border: "1px solid rgba(16,185,129,0.15)" }}
                  >
                    <Icon className="w-7 h-7" style={{ color: step.iconColor }} />
                  </div>
                  <h3 className="text-xl font-bold mb-3" style={{ color: "#E6EDF3" }}>{step.title}</h3>
                  <p className="leading-relaxed text-sm" style={{ color: "#8B949E" }}>{step.desc}</p>
                </motion.div>
              );
            })}
          </div>
